...
window.GAZE_MAPS = [
 ...
 },
 {
  ...
  "room": 5,
  "deccan": [],
  "prose": "<p class=\"subhead\">The thematic plate</p><p>On Plate 8 a colour key classifies density while the base map retains administrative divisions and major settlements.</p><p class=\"subhead\">Colour as quantity</p><p>The map is a choropleth: colour represents the intensity of a measured variable rather than political possession or physical relief. Millions of people are abstracted into zones that can be compared.</p><p class=\"subhead\">Statistics and government</p><p>The sheet belongs to a wider nineteenth-century culture of census, tabulation and comparative administration. The map shows how census data was made spatial: a society rendered as graded bands of colour.</p><p class=\"subhead\">On the sheet</p><p>The key is the 1891 census made into colour: ‘Colouring according to density of population 1891’, five bands from 0 to 100 inhabitants to the square mile up to ‘above 400’. The darkest band is a ribbon that follows the Ganges from the Punjab to the delta and reappears on the Malabar coast and in Travancore; the Deccan between Bombay and Hyderabad is among the palest parts of British India. The scheme spills over the frontier – ‘0 to 100’ is printed in red across Afghanistan, Baluchistan, Tibet and Siam – so that countries never counted are given the lowest band by default.</p><p class=\"subhead\">The gaze</p><p>Density is a ratio, and a ratio needs a denominator. Every band on this plate depends on the boundary drawn beneath it, so census figure and administrative division are fused: a unit is coloured by its average, and whatever varies inside it disappears.</p>",
  "meta": [
   [
    "Full title",
 ...
 },
 {
  ...
  "room": 5,
  "deccan": [],
  "prose": "<p class=\"subhead\">The physical plate</p><p>Plate 4 reduces political detail in favour of a thematic key and an inset continuation, allowing land-surface and vegetation patterns to dominate.</p><p class=\"subhead\">Nature classified</p><p>Relief, surface type and plant cover are separated from the general map and represented as their own layer of knowledge. The method reflects a scientific geography increasingly concerned with distribution, comparison and causal relation.</p><p class=\"subhead\">An atlas of layers</p><p>Viewed beside the population-density plate, the map reveals the organising ambition of the atlas. India can be decomposed into distinct thematic subjects – physical form, vegetation, people, products and administration – and reassembled through a sequence of plates.</p><p class=\"subhead\">On the sheet</p><p>The key has six classes – Forests, Bush and Small Wood, Cultivated Lands, Grassland, Steppes, Sandy Deserts and Barren Lands – and on the map the Western Ghats appear as a single green thread from the Gulf of Cambay to Cape Comorin, forest on the scarp and a paler cultivated wash on the plateau behind it. The Thar is pink, the Sundarbans brown, and Burma and Assam are carried on an inset in the lower right. The plate is numbered 4, near the front of the atlas, before the political sections begin.</p><p class=\"subhead\">The gaze</p><p>Whether a reader needed to know where scrub gave way to forest is doubtful; the plate exists because the scheme of the atlas required it. Once India had been split into layers, each layer had to be supplied, and the land surface was given its own key and colour so that the set would be complete.</p>",
  "meta": [
   [
    "Full title",
